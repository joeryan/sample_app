...
describe "User pages" do
	...
	describe "index" do
		...
		it { should have_correct_title('All users') }
		it { should have_correct_header('All users') }
  ...
  describe "profile page" do
	...
	describe "edit" do
		...
		describe "page" do
			it { should have_correct_header("Update your profile") }
			it { should have_correct_title("Edit user") }
		...
		describe "with valid information" do
			...
			it { should have_correct_header("#{new_name}") }
